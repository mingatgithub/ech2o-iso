...
void Budget::TotalStorage_cCl( const grid *Canopy, const grid *Canopy_cCl,
			       const grid *Snow, const grid *Snow_cCl,
			       const grid *Ponding, const grid *Ponding_cCl,
			       const grid *SoilL1, const grid *SoilL1_cCl,
			       const grid *ProotzoneL1,
			       ...
			       const Basin *b)//, const Control *ctrl)
{
  //cout << cClTot << " "<< cClsoilL1 << " " << cClsoilL2 << " " << cClsoilL3 << " " << 
    //  cClgrndwater << endl;
    //cout << cClcanopy << " "<< cClsnowpack << " " << cClponding << " " << endl;

  canopy_cCl = AccountTrckStorages(Canopy, Canopy_cCl, b);
  snowpack_cCl = AccountTrckStorages(Snow, Snow_cCl, b);
  ponding_cCl = AccountTrckStorages(Ponding, Ponding_cCl, b);
  soilL1_cCl = AccountTrckStorages(SoilL1, SoilL1_cCl, b);
  soilL2_cCl = AccountTrckStorages(SoilL2, SoilL2_cCl, b);
  soilL3_cCl = AccountTrckStorages(SoilL3, SoilL3_cCl, b);
  grndwater_cCl = AccountTrckStorages(GWater, GWater_cCl, b);

  // For BasincClSummary.txt
  //cout << cClsnowpack << endl;
  cClcanopy = AccountTrckStorages2(Canopy, Canopy_cCl, b);
  cClsnowpack = AccountTrckStorages2(Snow, Snow_cCl, b);
  cClponding = AccountTrckStorages2(Ponding, Ponding_cCl, b);
  cClsoilL1 = AccountTrckStorages2(SoilL1, SoilL1_cCl, b);
  cClsoilL2 = AccountTrckStorages2(SoilL2, SoilL2_cCl, b);
  cClsoilL3 = AccountTrckStorages2(SoilL3, SoilL3_cCl, b);
  cClgrndwater = AccountTrckStorages2(GWater, GWater_cCl, b);

  //cout << cClsnowpack << endl;
  cClvadose = AccountTrckVadose(SoilL1, SoilL1_cCl,
				SoilL2, SoilL2_cCl,
				SoilL3, SoilL3_cCl,
				//GWater, GWater_cCl,
				b);

  cClrootzone = AccountTrckRootZone(SoilL1, SoilL1_cCl, ProotzoneL1,
				    SoilL2, SoilL2_cCl, ProotzoneL2,
				    SoilL3, SoilL3_cCl, ProotzoneL3,
				    //GWater, GWater_cCl,
				    b);

  cClTot = AccountTrckDomain(Canopy, Canopy_cCl,
			     Snow, Snow_cCl,
			     Ponding, Ponding_cCl,
			     SoilL1, SoilL1_cCl,
			     SoilL2, SoilL2_cCl,
