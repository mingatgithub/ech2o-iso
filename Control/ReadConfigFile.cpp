...
int Control::ReadConfigFile(string confilename /*= "config.ini"*/)
{
  ...
  try{
    ...
    sw_channel_infilt = Config.read<bool>("Channel_Infiltration");
    ...
    Config.readInto(fn_Ksat0, "Horiz_Hydraulic_Conductivity");
    if(toggle_Ksat==1)
    ...
    Config.readInto(fn_poros0, "Porosity");
    if(toggle_Poros==1)
    ...
    Config.readInto(fn_SnowRainTemp, "Snow_rain_temp_threshold");
    ...
    Rep_Melt = Config.read<bool>("Report_Snowmelt");
    ...
    Rep_Net_Rad_tot = Config.read<bool>("Report_Total_Net_Rad");
    ...
    Rep_Latent_Heat_tot = Config.read<bool>("Report_Total_Latent_Heat");
    ...
    Rep_Sens_Heat_tot = Config.read<bool>("Report_Total_Sens_Heat");
    ...
    Rep_Leakage = Config.read<bool>("Report_Leakage_Out_of_System");
    ...
    Rep_Leakageacc = Config.read<bool>("Report_Leakage_Out_of_System_acc");
    ...
    RepTs_Melt = Config.read<bool>("Ts_Snowmelt");
    ...
    RepTs_Net_Rad_tot = Config.read<bool>("Ts_Total_Net_Rad");
    ...
    RepTs_Leakage = Config.read<bool>("Ts_Leakage_Out_of_System");
    // Lateral fluxes
