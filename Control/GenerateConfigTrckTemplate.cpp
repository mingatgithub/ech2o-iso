...
void GenerateConfigTrckTemplate(const char *fn){
  ...
  try {
    ...
    ofOut << "water_Cl = 0 # Chloride tracking" << endl;
    ...
    ofOut << "init_d2H_soil3 = d2H_soilL3.map" << endl << endl ;
    ...
    ofOut << "init_d18O_soil3 = d18O_soilL3.map" << endl << endl ;
    //ofOut << "init_d18O_groundwater = d18O_groundwater.map" << endl << endl;

    ofOut << "init_cCl_snowpack = cCl_snowpack.map" << endl;
    ofOut << "init_cCl_surface = cCl_surface.map" << endl;
    ofOut << "init_cCl_soil1 = cCl_soilL1.map" << endl;
    ofOut << "init_cCl_soil2 = cCl_soilL2.map" << endl;
    ofOut << "init_cCl_soil3 = cCl_soilL3.map" << endl << endl;
    //ofOut << "init_cCl_groundwater = cCl_groundwater.map" << endl << endl;
    ...
    ofOut << "init_Age_soil3 = Age_soilL3.map" << endl << endl ;
    ...
    ofOut << "Rep_cClprecip = 0" << endl;
    ofOut << "Rep_cClcanopy = 0" << endl;
    ofOut << "Rep_cClcanopy_sum = 0" << endl;
    ofOut << "Rep_cClsnowpack = 0" << endl;
    ofOut << "Rep_cClsnowmelt = 0" << endl;
    ofOut << "Rep_cClsurface = 0" << endl;
    ofOut << "Rep_cClsoil1 = 0" << endl;
    ofOut << "Rep_cClsoil2 = 0" << endl;
    ofOut << "Rep_cClsoilUp = 0" << endl;
    ofOut << "Rep_cClsoil3 = 0" << endl;
    ofOut << "Rep_cClsoilAv = 0" << endl;
    ofOut << "Rep_cClgroundwater = 0" << endl;
    ofOut << "Rep_cClsoil1_MobileWater = 0" << endl ;
    ofOut << "Rep_cClsoil2_MobileWater = 0" << endl ;
    ofOut << "Rep_cClsoil1_TightlyBound = 0" << endl ;
    ofOut << "Rep_cClsoil2_TightlyBound = 0" << endl << endl;

    ofOut << "Rep_Agecanopy = 0" << endl;
    ofOut << "Rep_Agecanopy_sum = 0" << endl;
    ofOut << "Rep_Agesnowpack = 0" << endl;
    ofOut << "Rep_Agesnowmelt = 0" << endl;
    ...
    ofOut << "Ts_cClprecip = 0" << endl;
    ofOut << "Ts_cClcanopy = 0" << endl;
    ofOut << "Ts_cClcanopy_sum = 0" << endl;
    ofOut << "Ts_cClsnowpack = 0 " << endl;
    ofOut << "Ts_cClsnowmelt = 0 " << endl;
    ofOut << "Ts_cClsurface = 1" << endl;
    ofOut << "Ts_cClsoil1 = 1" << endl;
    ofOut << "Ts_cClsoil2 = 1" << endl;
    ofOut << "Ts_cClsoilUp = 0" << endl;
    ofOut << "Ts_cClsoil3 = 0" << endl;
    ofOut << "Ts_cClsoilAv = 0" << endl;
    ofOut << "Ts_cClgroundwater = 1" << endl;
    ofOut << "Ts_cClsoil1_MobileWater = 0" << endl ;
    ofOut << "Ts_cClsoil2_MobileWater = 0" << endl ;
    ofOut << "Ts_cClsoil1_TightlyBound = 0" << endl ;
    ofOut << "Ts_cClsoil2_TightlyBound = 0" << endl << endl;

    ofOut << "Ts_Agecanopy = 0" << endl;
    ofOut << "Ts_Agecanopy_sum = 0" << endl;
    ofOut << "Ts_Agesnowpack = 1" << endl;
    ofOut << "Ts_Agesnowmelt = 1" << endl;
